...
class MatchApi {
  ...
  static getCompetitionMatches(competition) {
    console.log('calling getCompetitionMatches..');
    return new Promise((resolve) => {
      setTimeout(() => {
        resolve(Object.assign([], competitionMatches[competition].matches));
      }, delay);
    });
  }

  static getCompetitionStandings(competition) {
    console.log('calling getCompetitionStandings..');
    return new Promise((resolve) => {
      setTimeout(() => {
  ...
  static getCompetitionTeams(competition) {
    console.log('calling getCompetitionTeams..');
    return new Promise((resolve) => {
      setTimeout(() => {
