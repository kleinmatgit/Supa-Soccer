...
class MatchCard extends React.Component {
  ...
  getClassNameDate = () => {
    let cls = '';
    if(StatusHelper.getStatus(this.props.match.status) === 'FT') {
                ...
                <td>
                  <div className="match-card-status-table">
                    <table>
                      <tbody>
                        <tr>
                          <td>{StatusHelper.getStatus(this.props.match.status)}</td>
                        </tr>
                        <tr>
                          <td className={this.getClassNameDate()}>{this.formatDate()}</td>
                        </tr>
                        <tr>
                          <td className={this.getClassNameDate()}>{this.formatTime()}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
