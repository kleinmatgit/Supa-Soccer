...
import StandingHanlder from 'components/StandingHandler';
...
class CompetitionPage extends React.Component {
  ...
  render() {
    return (
      <div>
        <CompetitionTitle competition={this.props.competition} />
        <CompetitionButtons
          ...
          {this.props.displayMode === DisplayMode.MATCHES
            ...
            : this.props.displayMode === DisplayMode.STANDINGS
              ? this.props.standingsLoading
                ? <LoadingDots dots={5} />
                : <StandingHanlder standings={this.props.standings} />
