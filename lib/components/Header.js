      ...
      <Navbar inverse={true}>
        ...
        <Navbar.Collapse>
          <Nav>
            ...
            <NavItem eventKey={4} onClick={this.onPremierLeagueClick}>{comp.PREMIER_LEAGUE}</NavItem>
            <NavItem eventKey={5} onClick={this.onBundesligaClick}>{comp.BUNDESLIGA}</NavItem>
          </Nav>
        </Navbar.Collapse>
      </Navbar>
    </div>
